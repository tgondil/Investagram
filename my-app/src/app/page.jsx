          ...
          <div className="w-10/12 delay-5000 animate-intro-unhide">
            ...
            <div class="mb-4 w-full animate-intro-unhide">
              ...
              <button class="mt-3 text-lg mt-8 font-semibold 
                ...
                px-6 py-3 block shadow-xl hover:text-white hover:animate-text hover:font-bold hover:bg-gradient-to-r hover:from-teal-500 hover:via-tacao-300 hover:to-teal-500 hover:bg-clip-text hover:text-transparent">
                Login
              </button>
